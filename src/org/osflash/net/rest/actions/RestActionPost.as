package org.osflash.net.rest.actions
{
	 ...
	 */
	public class RestActionPost extends RestAction implements IRestActionGet
	{
		
		public function RestActionPost(service : IRestService)
		{
			super(service);
		}
		 ...
		 * @inheritDoc
		 */
		override public function get type() : RestActionType { return RestActionType.POST; }
	}
}
